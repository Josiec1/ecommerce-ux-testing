...
- **Mobile viewport testing**: key flows validated on 390×844 (iPhone)
- **Data-driven scenario coverage**: test cases derived from systematic merchant user journey analysis

## Project Structure
ecommerce-ux-testing/
├── conftest.py                          # shared fixtures (login, browser, mobile)
├── pytest.ini                           # pytest configuration
├── tests/
│   ├── product_listing/
│   │   └── test_product_listing.py     # catalog browsing, sorting, navigation
│   ├── order_management/
│   │   └── test_order_management.py    # cart add/remove, persistence
│   └── checkout/
│       └── test_checkout.py            # checkout flow, form validation
└── .github/workflows/
...
# Run specific module
pytest tests/product_listing/ -v
pytest tests/order_management/ -v
